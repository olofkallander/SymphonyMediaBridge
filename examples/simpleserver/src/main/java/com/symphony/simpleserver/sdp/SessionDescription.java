...
public class SessionDescription
{
    ...
    public Boolean extmapAllowMixed;
    ...
    private void handleConnectionInfo(String line, ParserState parserState) throws ParserFailedException
    {
        ...
        final Connection newConnection =
            new Connection(Types.Net.fromString(tokens[0]), Types.Address.fromString(tokens[1]), tokens[2]);
    ...
    private void handleAttribute(String line, ParserState parserState) throws ParserFailedException
    {
        ...
        case "sctp-port":
            handleSctpPort(tail, parserState);
            break;
    ...
    private void handleRtcp(String line, ParserState parserState) throws ParserFailedException
    {
        ...
        {
            connection =
                new Connection(Types.Net.fromString(tokens[1]), Types.Address.fromString(tokens[2]), tokens[3]);
        }
    ...
    private void handleSctpPort(String line, ParserState parserState) throws ParserFailedException
    {
        validateParserState(parserState, false, line);

        final MediaDescription mediaDescription = mediaDescriptions.get(parserState.currentMediaContentIndex);

        final SctpMap newSctpMap = new SctpMap(Integer.parseInt(line), "application");
        newSctpMap.maxMessageSize = 252000;
    ...
    private static void validateParserState(ParserState parserState, boolean isGlobalAttribute, String sdpLine)
